...
const Earthquakes: React.FC = () => {
  ...
  const generateImageUrl = (): string => {
    ...
    return `https://www.vedur.is/photos/jarrnes/${year}${month}${day}_${hours}${minutes}.png`;
  };
  ...
  const generateSecondImageUrl = (): string => {
    ...
    return `https://www.vedur.is/photos/jarrnes_rit/${year}${month}${day}_${hours}${minutes}.png`;
  };
